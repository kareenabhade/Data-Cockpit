...
const SourceFilter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!source || !criteria || !criteriaValue) {
      ...
      <Box sx={{ mt: 10, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <form onSubmit={handleSubmit}>
          <FormControl sx={{ mb: 3, width: '100%' }}>
            <InputLabel htmlFor="source-input">Enter Source</InputLabel>
            <Input
              id="source-input"
              value={source}
            ...
            />
            <FormHelperText id="source-helper-text">Enter a valid source</FormHelperText>
          </FormControl>
          ...
          <FormControl sx={{ mb: 3, width: '100%' }}>
            ...
            <FormHelperText>Select the criteria to update source</FormHelperText>
          </FormControl>
