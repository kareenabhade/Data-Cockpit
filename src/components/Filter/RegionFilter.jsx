...
const RegionFilter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!region || !criteria || !criteriaValue) {
      ...
      <Box sx={{ mt: 10, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <form onSubmit={handleSubmit}>
          <FormControl sx={{ mb: 3, width: '100%' }}>
            <InputLabel htmlFor="region-input">Enter Region</InputLabel>
            <Input
              id="region-input"
              value={region}
              onChange={(e) => setRegion(e.target.value)}
              aria-describedby="region-helper-text"
            />
            <FormHelperText id="region-helper-text">Enter a valid region</FormHelperText>
          </FormControl>
          ...
          <FormControl sx={{ mb: 3, width: '100%' }}>
            ...
            <FormHelperText>Select the criteria to update region</FormHelperText>
          </FormControl>
