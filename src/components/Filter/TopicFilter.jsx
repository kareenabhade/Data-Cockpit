...
const TopicFilter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!topic || !criteria || !criteriaValue) {
      ...
      <Box sx={{ mt: 10, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <form onSubmit={handleSubmit}>
          <FormControl sx={{ mb: 3, width: '100%' }}>
            <InputLabel htmlFor="topic-input">Enter Topic</InputLabel>
            <Input
              id="topic-input"
              value={topic}
            ...
            />
            <FormHelperText id="topic-helper-text">Enter the topic to filter</FormHelperText>
          </FormControl>
          ...
          <FormControl sx={{ mb: 3, width: '100%' }}>
            ...
            <FormHelperText>Select the criteria to filter by</FormHelperText>
          </FormControl>
